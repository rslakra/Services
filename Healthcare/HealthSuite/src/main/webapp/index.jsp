...
<div class="container">
    <div class="hero-unit">
        <div>
            <h1>Welcome to dHealth Tracker!</h1>
            <p>To get started, we need to enter a goal for what we want to exercise for today.</p>
        </div>
        <a class="btn btn-primary" href="addRegistration.html"> Add Registration � </a>
        <a class="btn btn-primary" href="addUsers.html"> Add Users � </a>
        <br>
