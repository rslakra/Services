...
public class TutorialWebController {
     ...
     */
    @Autowired
    public TutorialWebController(final TutorialService tutorialService) {
     ...
     */
    @GetMapping
    public String getTutorials(Model model, @Param("keyword") String keyword) {
        try {
        ...
        return "views/tutorial/listTutorials";
    }
    ...
    public String addTutorial(Model model) {
        ...
        return "views/tutorial/editTutorial";
    }
