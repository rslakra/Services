package com.rslakra.springbootsamples.springbootaspects.aop;
...
public class LogMethodExecutionAspect {
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.rslakra.springbootsamples.springbootaspects.annotation.LogMethodExecutionTime)")
