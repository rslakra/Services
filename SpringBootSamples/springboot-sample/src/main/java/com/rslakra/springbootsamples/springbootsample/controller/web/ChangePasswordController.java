package com.rslakra.springbootsamples.springbootsample.controller.web;

import com.rslakra.springbootsamples.springbootsample.domain.user.IdentityDO;
import com.rslakra.springbootsamples.springbootsample.dto.LoggedInUserRequest;
import com.rslakra.springbootsamples.springbootsample.dto.PasswordChangeRequest;
import com.rslakra.springbootsamples.springbootsample.repository.IdentityRepository;
import com.rslakra.springbootsamples.springbootsample.service.UserService;
...
public class ChangePasswordController {
    ...
    @PostMapping
    @Transactional
    public String handelPasswordChange(@ModelAttribute("passwordChangeForm") @Validated PasswordChangeRequest form, BindingResult result) {
        ...
        if (user == null) {
            ...
            result.rejectValue("confirmPassword", null, "You must enter the same password twice in order to confirm it.");
