...
public enum BeanUtils {
    ...
    public static int getLength(final Object object) {
        if (isNotNull(object)) {
            ...
            } else if (object instanceof Map && Map.class.isAssignableFrom(classType)) {
                return ((Map) object).size();
            } else if (object instanceof Collection && Collection.class.isAssignableFrom(classType)) {
     ...
     * @return
     */
    public static String toString(final Object message, final String defaultMessage) {
        return (isNull(message) ? defaultMessage : toString(message));
    }
